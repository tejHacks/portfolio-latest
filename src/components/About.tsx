                    ...
                    <div className="space-y-8">
                        <div className="bg-slate-900/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50">
                            ...
                            <div className="space-y-4 text-slate-300 leading-relaxed">
                                ...
                                <p>
                                    My expertise lies in front-end and back-end development, from designing robust APIs and structuring databases to writing maintainable, high-performance code. My core stack includes <strong className="text-amber-400">React, Node, PHP, Laravel, MySQL, and Python</strong>. I am also skilled in <strong className="text-blue-400">Vue.js, React Native</strong>, and <strong className="text-green-400">Linux environments</strong>.
                                </p>
                                <p>
