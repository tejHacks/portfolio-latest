        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4 text-slate-300 leading-relaxed">
                <p>
                  <strong className="text-emerald-400">
                    Hey, I'm Olateju Olamide Emmanuel.
                  </strong>{" "}
                  I'm a Computer Science graduate and Software Engineer
                  specializing in full-stack and mobile development. I craft
                  scalable systems with clean architecture, responsive UIs, and
                  robust logic to tackle real-world challenges, from web
                  backends to cross-platform apps.
                </p>

                <p>
                  My expertise spans full-stack development—building APIs,
                  databases, and frontends—alongside mobile innovation with{" "}
                  <strong className="text-amber-400">React Native</strong>. My
                  core stack includes{" "}
                  <strong className="text-amber-400">
                    React, Node.js, PHP, Laravel, MySQL, and Python
                  </strong>
                  , with <strong className="text-blue-400">React Native</strong>{" "}
                  powering seamless mobile experiences. I also thrive in{" "}
                  <strong className="text-green-400">Linux environments</strong>
                  , optimizing deployments and debugging on Ubuntu.
                </p>
                <p>
                  I think in systems, not just code. Performance, reliability,
                  and user-friendly mobile interfaces drive me. I love tools
                  like <strong className="text-purple-400">Docker</strong> for
                  containerized apps and{" "}
                  <strong className="text-orange-400">Git</strong> for version
                  control, ensuring smart, scalable development workflows.
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-900/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50">
              ...
              <div className="space-y-4 text-slate-300 leading-relaxed">
                <p>
                  Beyond coding, I’m a self-driven learner. My passion fuels
                  exploration into{" "}
                  <strong className="text-emerald-400">
                    system design, mobile optimization, dev tooling, and
                    open-source contributions
                  </strong>
                  . With <strong className="text-blue-400">React Native</strong>
                  , I’ve built apps like DevMind and Shelfly (check
                  tejuthedev.vercel.app), blending full-stack logic with mobile
                  finesse.
                </p>

                <p>
                  I thrive on breaking and fixing—learning fastest when things
                  get tough. I’m seeking{" "}
                  <strong className="text-emerald-400">
                    full-stack and mobile-focused software engineering roles
                  </strong>{" "}
                  where I can innovate, grow with a stellar team, and create
                  impactful solutions, from web backends to mobile-first
                  experiences.
                </p>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-400 text-sm mt-4">
                Featuring my React Native Linux Commands app, a 96% accurate AI
                model, and 20+ full-stack/mobile projects.
              </p>
            </div>
          </div>
