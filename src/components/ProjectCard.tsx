...
const ProjectCard = ({
  ...
  return (
    <div className="bg-black/70 backdrop-blur-md rounded-xl border border-slate-700/50 overflow-hidden hover:border-blue-500/50 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg flex flex-col">
      {/* Image Section */}
      {image && (
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        {category && (
          <span className={`text-${color}-400 text-sm mb-1`}>{category}</span>
        )}
