...
const Skills = () => {
    ...
    },
    {
      ...
      skills: [
        ...
        },
        {
          name: "SQLite",
          level: 80,
          icon: <SiSqlite className="text-purple-300" />,
        },
        {
          name: "MariaDB",
          level: 75,
          icon: <SiMariadb className="text-blue-300" />,
        },
        {
          name: "MongoDB",
          level: 75,
          icon: <SiMongodb className="text-blue-300" />,
        },
      ],
    },
    {
      ...
      skills: [
        ...
        },
        {
          name: "Fedora",
          level: 85,
          icon: <SiFedora className="text-blue-400" />,
        },
        {
          name: "Windows",
          level: 90,
    ...
    },
    {
      ...
      skills: [
        ...
        },
        {
          name: "Parrot OS",
          level: 70,
          icon: <SiParrotsecurity className="text-green-300" />,
        },
        {
    ...
    },
    {
      ...
      skills: [
        ...
        },
        {
          name: "Data Analysis",
          level: 50,
          icon: <FaVial className="text-fuchsia-400" />,
        },
        {
          name: "OpenCV",
          level: 55,
          icon: <SiOpencv className="text-slate-300" />,
        },
      ],
    },
  ];
  ...
  const getColorClasses = (color: string) => {
    const colors = {
      emerald:
        "from-emerald-600 to-emerald-700 border-emerald-500/50 shadow-emerald-500/25",
      blue: "from-blue-600 to-blue-700 border-blue-500/50 shadow-blue-500/25",
      purple:
        "from-purple-600 to-purple-700 border-purple-500/50 shadow-purple-500/25",
      amber:
        "from-amber-600 to-amber-700 border-amber-500/50 shadow-amber-500/25",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-400 max-w-3xl mx-auto">
            A comprehensive toolkit for building scalable, maintainable
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {skillCategories.map((category, categoryIndex) => (
            ...
            >
              {/* Category Header */}
              <div
                className={`flex items-center space-x-3 mb-6 p-3 rounded-xl bg-gradient-to-r ${getColorClasses(category.color)} border shadow-lg`}
              >
        ...
        <div className="mt-16 text-center">
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 max-w-4xl mx-auto">
            ...
            <p className="text-slate-300 text-lg leading-relaxed">
              ...
              impactful full-stack and mobile solutions. Whether it’s mastering
              React Native with Expo and Firebase or diving into system
              architecture, I’m always ready to tackle the next challenge with
