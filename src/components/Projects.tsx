...
const Projects = () => {
  const mlProjects = [
    ...
    },
    {
      ...
      description:
        "Aim: Deep learning model using ultrasound images for breast cancer detection.Developed for Final Year Research Project before undergoing the Speaker Dirizaition Model Development.",
      techStack: [
        "Python",
        "TensorFlow",
        "OpenCV",
  ...
  const webProjects = [
    {
      title: "CppCamp",
      description:
        "A multi functional next-gen platform for mastering C++ with hands-on practice, smart tools, AI based mentor and learning resources plus straightfroward curriculum and simplified approach to learning plus fully functional web based code editor",
      techStack: [
        "JavaScript",
        "React",
        "TypeScript",
    ...
    },
    {
      title: "Lumicare AI",
      description:
        "A multi functional web app designed to detect jaundice in babies using a custom-built Computer Vision based model. I and 2 of my colleagues built this model for the HelpMum carecode Hackathon and our models accuracy was over 96% after training and fine-tuning,I handled the models deployment and designed the frontend and backend of the entire web application architecture.",
      techStack: [
        "JavaScript",
        "React",
        "TypeScript",
    ...
    },
    {
      title: "MamaCare ",
      description:
        "A multi functional web application designed to help pregnant mothers in the pregnancy stage with multiple features tailored towards aiding them(Pregnancy Tracker,BMI Calculator, Jaundice Checker, Skin disease checker, Pediatrician Finder, Grocery store and more.) ",
      techStack: [
        "JavaScript",
        "React",
        "TypeScript",
    ...
    },
    {
      ...
      description:
        "Test your Bible knowledge and have fun learning God's Word!",
    ...
    },
    {
      ...
      description:
        "My first random Bible verse Chrome extension—replaces your new tab with inspiring daily Bible verses and Psalms for a quick spiritual boost. Simple, lightweight, and easy to install.",
    ...
    },
    {
      ...
      description:
        "A compact PHP web app for storing, viewing, and organizing your favorite Linux commands—perfect for quick reference and CLI workflows.",
    ...
    },
    {
      ...
      description:
        "Another handy PHP-based commands keeper, this time focused on Docker—save, search, and manage container commands for smoother devops flows.",
      techStack: ["PHP", "MySQL", "Bootstrap", "JavaScript"],
      image: Image15,
      liveDemo: null,
    ...
    },
    {
      ...
      description:
        "A PHP web tool for managing Nmap commands with copy-to-clipboard, dark mode, and secure execution previews—built for pentesting enthusiasts (execution safety in progress).",
    ...
    },
    {
      ...
      description:
        "Full-featured PHP system for Achievers University library—handles student/lecturer registrations, book tracking, borrowing, searches, and reading plans to streamline workflows.",
    ...
    },
    {
      title: "SnipHub",
      description:
        "Minimalist PHP code snippet manager with auth, CRUD ops, search, and a hacker-themed UI—toggle dark mode and store your snippets like a pro.",
    ...
    },
    {
      title: "Learn Spanish",
      description:
        "Learn Spanish with this simple app built with Vue and Vite.. Features text to Speech via Web based SpeechUtterance API in JavaScript and Composition API In Vue.",
    ...
    },
    {
      ...
      description:
        "Secure password management system with encryption, password generation, and organized storage. Built with PHP and MySQL, featuring strong encryption algorithms and user authentication for protecting sensitive credentials.",
